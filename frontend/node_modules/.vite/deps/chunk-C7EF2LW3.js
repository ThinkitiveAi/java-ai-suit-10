...
function createContainer(options = {}) {
  ...
  const Container2 = React24.forwardRef(function Container3(inProps, ref) {
    ...
    return (0, import_jsx_runtime12.jsx)(ContainerRoot, {
      as: component,
      ownerState,
...
function shouldSkipGeneratingVar(keys) {
  var _a;
  return !!keys[0].match(/(cssVarPrefix|colorSchemeSelector|modularCssLayers|rootSelector|typography|mixins|breakpoints|direction|transitions)/) || !!keys[0].match(/sxConfig$/) || keys[0] === "palette" && !!((_a = keys[1]) == null ? void 0 : _a.match(/(mode|contrastThreshold|tonalOffset)/));
}
 ...
 * LICENSE file in the root directory of this source tree.
 */
//# sourceMappingURL=chunk-C7EF2LW3.js.map
